...
var Header = ({ navigation }) => {
  ...
  return /* @__PURE__ */ (0, import_jsx_dev_runtime4.jsxDEV)("header", { className: "2xl w-full lg:p-8 lg:px-6", children: [
    ...
    /* @__PURE__ */ (0, import_jsx_dev_runtime4.jsxDEV)("div", { className: "lg:mb-5 mb-20", children: checkoutFlow.includes(location.pathname) ? /* @__PURE__ */ (0, import_jsx_dev_runtime4.jsxDEV)("nav", { className: "flex container px-4 mx-auto gap-20 flex-auto items-center justify-between mb-5 w-full", children: [
      ...
      /* @__PURE__ */ (0, import_jsx_dev_runtime4.jsxDEV)("div", { className: "flex flex-auto items-center justify-end h-[40px] w-[100px]", children: /* @__PURE__ */ (0, import_jsx_dev_runtime4.jsxDEV)(Link_default, { to: path("/orders"), className: "p-2 rounded-md hover:bg-[#efefef]", children: /* @__PURE__ */ (0, import_jsx_dev_runtime4.jsxDEV)(
        "img",
        {
...
//# sourceMappingURL=/build/root-FFNN5CRN.js.map
