import {
  Document
} from "/build/_shared/chunk-2FJRNLBJ.js";
import {
  buildMetas
...
var Stories_default = ({ folder }) => {
  ...
  return /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", { className: "container 2xl md:px-6 mx-auto w-full p-10", children: [
    ...
    /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", { className: "grid md:grid-cols-2 lg:grid-cols-3 gap-3 mt-10 grid-flow-row flex flex-wrap", children: (_a = folder == null ? void 0 : folder.children) == null ? void 0 : _a.map((child) => {
...
//# sourceMappingURL=/build/routes/$langstore/stories/index-PVBHRO56.js.map
