...
function getHost(request) {
  var _a;
  if ((_a = process.env) == null ? void 0 : _a.SUPERFAST_HOST) {
...
function getContext(request) {
  ...
  const langMarket = (_a = url.pathname.split("/")[1]) != null ? _a : "";
  const language = (_b = langMarket.split("-")[0]) != null ? _b : availableLanguages[0];
  ...
  return {
    ...
    isSecure: isHttps,
    host,
    isPreview: Boolean((_c = url.searchParams) == null ? void 0 : _c.has("preview")),
    url,
...
//# sourceMappingURL=/build/_shared/chunk-AP3K5O7S.js.map
