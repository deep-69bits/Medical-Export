...
var Header = ({ navigation }) => {
  ...
  return /* @__PURE__ */ (0, import_jsx_dev_runtime5.jsxDEV)("header", { className: "2xl w-full mx-auto lg:p-8 lg:px-6", children: [
    ...
    /* @__PURE__ */ (0, import_jsx_dev_runtime5.jsxDEV)("div", { className: "lg:mb-5 mb-20", children: checkoutFlow.includes(location.pathname) ? /* @__PURE__ */ (0, import_jsx_dev_runtime5.jsxDEV)("nav", { className: "flex container px-4 mx-auto gap-20 flex-auto items-center justify-between mb-5 w-full", children: [
      ...
      lineNumber: 75,
      columnNumber: 21
    }, this) : /* @__PURE__ */ (0, import_jsx_dev_runtime5.jsxDEV)("div", { className: " fixed z-40 bg-[#fff] w-full left-0 top-0", children: /* @__PURE__ */ (0, import_jsx_dev_runtime5.jsxDEV)("div", { className: "flex flex-auto items-center mx-auto px-6 xl:container pt-3 pb-2", children: [
...
//# sourceMappingURL=/build/root-NWDHIWEO.js.map
