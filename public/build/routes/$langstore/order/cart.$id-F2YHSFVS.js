...
var OrderPlacedCart_default = ({ cartId }) => {
  ...
  const [tryCount, setTryCount] = (0, import_react2.useState)(0);
  const { state: appContextState, path } = useAppContext();
  const navigate = useNavigate_default();
  const [orderGuestId, setOrderGuestId] = (0, import_react2.useState)("");
...
//# sourceMappingURL=/build/routes/$langstore/order/cart.$id-F2YHSFVS.js.map
