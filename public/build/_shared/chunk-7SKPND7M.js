...
function stringForSingleLineComponentWithId(components, id) {
  var _a, _b;
  return (_b = (_a = components.find((component) => component.id === id)) == null ? void 0 : _a.content) == null ? void 0 : _b.text;
}
...
var fetchFolderToCategory_default = (data) => {
  ...
  const firstSeoChunk = (_e = data.meta.content) == null ? void 0 : _e.chunks[0];
  const dto = {
    name: data.name,
    path: data.path,
    title: stringForSingleLineComponentWithId(data.components, "title") || data.name,
    ...
    hero: grid ? {
      id: `grid-${(_f = hero == null ? void 0 : hero.id) != null ? _f : data.id}`,
      ...grid
    } : void 0,
    seo: mapper.API.Object.APIMetaSEOComponentToSEO(firstSeoChunk)
  };
...
var fetchLandingPageToLandingPage_default = (data) => {
  var _a, _b;
  const mapper = DataMapper();
  const firstSeoChunk = (_b = (_a = data == null ? void 0 : data.meta.content) == null ? void 0 : _a.chunks) == null ? void 0 : _b[0];
  return {
    name: data.name,
    path: data.path,
    seo: mapper.API.Object.APIMetaSEOComponentToSEO(firstSeoChunk),
...
//# sourceMappingURL=/build/_shared/chunk-7SKPND7M.js.map
