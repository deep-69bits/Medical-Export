...
var MagickLoginForm = ({ enabledGuest, title, actionTitle, onlyLogin = false }) => {
  ...
  return /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", { className: "flex flex-col mt-5 gap-2 w-full sm:min-w-[400px]", children: [
    ...
    /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("button", { type: "submit", onClick: submit, className: "bg-black text-white rounded-md px-6 py-3 mt-5 ", children: "Inquire" }, void 0, false, {
      fileName: "src/ui/components/checkout-forms/magicklogin.tsx",
      lineNumber: 160,
      columnNumber: 25
    }, this)
...
//# sourceMappingURL=/build/_shared/chunk-RGV45RP2.js.map
