...
var VariantSelector = ({ variants, selectedVariant, onVariantChange, renderingType = "default" }) => {
  ...
  const renderingTypes = {
    default: /* @__PURE__ */ (0, import_jsx_dev_runtime2.jsxDEV)("div", { children: Object.keys(attributes).map((key) => {
      const values = attributes[key];
      return /* @__PURE__ */ (0, import_jsx_dev_runtime2.jsxDEV)("div", { className: "border-[#dfdfdf]", children: [
        /* @__PURE__ */ (0, import_jsx_dev_runtime2.jsxDEV)("p", { className: "mt-2 text-sm  font-semibold", children: key }, void 0, false, {
          fileName: "src/ui/components/variant-selector.tsx",
          lineNumber: 60,
          columnNumber: 29
        }, this),
        /* @__PURE__ */ (0, import_jsx_dev_runtime2.jsxDEV)("div", { className: "flex mb-5 flex-nowrap md:flex-wrap gap-2 overflow-x-scroll py-2 px-1", children: values.map((value) => {
          var _a;
          ...
          return /* @__PURE__ */ (0, import_jsx_dev_runtime2.jsxDEV)(
            "button",
            {
              ...
              children: [
                /* @__PURE__ */ (0, import_jsx_dev_runtime2.jsxDEV)("div", { className: "img-container p-3 w-[80px] img-contain", children: ((_a = mostSuitableVariant == null ? void 0 : mostSuitableVariant.images) == null ? void 0 : _a[0]) && /* @__PURE__ */ (0, import_jsx_dev_runtime2.jsxDEV)(
                  import_image.Image,
                  {
    ...
    dropdown: /* @__PURE__ */ (0, import_jsx_dev_runtime2.jsxDEV)(import_jsx_dev_runtime2.Fragment, { children: Object.keys(attributes).map((key) => {
      const values = attributes[key];
      return /* @__PURE__ */ (0, import_jsx_dev_runtime2.jsxDEV)("label", { className: "block", children: /* @__PURE__ */ (0, import_jsx_dev_runtime2.jsxDEV)(
        "select",
        {
          ...
          children: /* @__PURE__ */ (0, import_jsx_dev_runtime2.jsxDEV)("optgroup", { label: key, children: values.map((value) => {
            const mostSuitableVariant = findMostSuitableVariant(variants, {
              ...selectedVariant.attributes,
              [key]: value
            });
            return /* @__PURE__ */ (0, import_jsx_dev_runtime2.jsxDEV)("option", { disabled: !mostSuitableVariant, value, children: value }, value, false, {
              fileName: "src/ui/components/variant-selector.tsx",
              lineNumber: 117,
              columnNumber: 45
            }, this);
...
//# sourceMappingURL=/build/_shared/chunk-VPG5GESH.js.map
