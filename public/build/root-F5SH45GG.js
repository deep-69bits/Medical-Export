  ...
  return /* @__PURE__ */ (0, import_jsx_dev_runtime5.jsxDEV)("header", { className: "2xl w-full lg:p-8 lg:px-6", children: [
    ...
    /* @__PURE__ */ (0, import_jsx_dev_runtime5.jsxDEV)("div", { className: "lg:mb-5 mb-20", children: checkoutFlow.includes(location.pathname) ? /* @__PURE__ */ (0, import_jsx_dev_runtime5.jsxDEV)("nav", { className: "flex container px-4 mx-auto gap-20 flex-auto items-center justify-between mb-5 w-full", children: [
      ...
      /* @__PURE__ */ (0, import_jsx_dev_runtime5.jsxDEV)("div", { className: "flex mx-auto flex-auto justify-between items-center relative", children: /* @__PURE__ */ (0, import_jsx_dev_runtime5.jsxDEV)("div", { className: "flex gap-4 md:gap-10 items-center", children: [
        /* @__PURE__ */ (0, import_jsx_dev_runtime5.jsxDEV)(Link_default, { to: path("/"), children: /* @__PURE__ */ (0, import_jsx_dev_runtime5.jsxDEV)("div", { className: "max-h-[80px] h-[30px]  img-container", children: /* @__PURE__ */ (0, import_jsx_dev_runtime5.jsxDEV)(
          TenantLogo,
          {
            logo: appContextState.logo,
            identifier: appContextState.crystallize.tenantIdentifier
          ...
          "div",
          {
            ...
            children: [
              ...
              (_a = navigation == null ? void 0 : navigation.folders) == null ? void 0 : _a.filter((item) => {
                ...
                return item.name == "Shop" || item.name == "Stories" ? "" : /* @__PURE__ */ (0, import_jsx_dev_runtime5.jsxDEV)(
                  Link_default,
                  {
                    to: path(item.path),
                    prefetch: "intent",
...
//# sourceMappingURL=/build/root-F5SH45GG.js.map
